...
// Revision History :
public  class WeovnextRcptAdjt implements Serializable {
    ...
    public String toString() {
        return "WeovnextRcptAdjt [VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=uidUpdated, value=null] =" + VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=uidUpdated, value=null] + " ,VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=timeUpdated, value=null] =" + VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=timeUpdated, value=null] + " ,VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=nextRcptAdjtId, value=null] =" + VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=nextRcptAdjtId, value=null]+ "]";
    }
}