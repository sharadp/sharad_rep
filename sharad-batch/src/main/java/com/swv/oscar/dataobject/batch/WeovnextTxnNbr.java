...
// Revision History :
public  class WeovnextTxnNbr implements Serializable {

    private String uidUpdated;
    private String timeUpdated;
    private String nextTxnNbr;
    ...
    public String getNextTxnNbr() {
        return nextTxnNbr;
    }

    public void setNextTxnNbr(String nextTxnNbr ) {
        this.nextTxnNbr = nextTxnNbr;
    }

    @Override
    public String toString() {
        return "WeovnextTxnNbr [VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=uidUpdated, value=null] =" + VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=uidUpdated, value=null] + " ,VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=timeUpdated, value=null] =" + VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=timeUpdated, value=null] + " ,VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=nextTxnNbr, value=null] =" + VarDefContext [accessSpecifiers=null, keyword=null, dataType=String, varName=nextTxnNbr, value=null]+ "]";
    }
}